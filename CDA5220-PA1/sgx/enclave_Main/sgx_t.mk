...
Main_Cpp_Files := $(TRUSTED_DIR)/Main.cpp $(TRUSTED_DIR)/MyNewTrustedMain.cpp
Main_C_Files := 
...
Main.so: $(TRUSTED_DIR)/Main_t.o $(Main_Cpp_Objects) $(Main_C_Objects) ../trustedlib_lib1/liblib1.sgx.static.lib.a
